...
\noindent Ardavan Khalij: Costumer database and queries, Costumer ontology, Costumer mapping, 2 costumer SPARQL queries, Report discussion, ...
\\

\noindent Amadou Sarjo Jallow: Product database and queries, Product ontology, Product mapping, 1 product SPARQL query.
\\

\noindent Brenda Ordoñez Lujan: Supplier database and queries, Supplier ontology, Supplier mapping, 1 supplier SPARQL query, Report mapping, ...
\\

\noindent Florent Nicolas J Grimau: Delivery service database and queries, Delivery service ontology, Delivery service mapping.
\\
...
\section{Discussion}
Overall, there were some problems and challenges in communication between the teammates, especially with the COVID-19 situation. Also the unavailability of some of the teammates didn't help in this situation. Still, with the hard work of everyone in the group, it became possible to finish this project. The main challenge of the project was merging the databases and making them into a single database in Dremio. In addition, there were some problems in installing and using Dremio, Ontop and Oxigraph for most of the group. As a result, testing the SPARQL queries was very hard and frustrating.
